...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        try {
            ...
            $contenido = '<html>';
            $contenido .= "<p><strong>Hola " . $fullName .  "</strong> Has Creado tu cuenta en DevWebCamp, solo debes confirmarla presionando el siguiente enlace</p>";
    ...
    public function enviarInstrucciones()
    {
        ...
        try {
            ...
            $contenido .= "<p>Presiona aquí: <a href='". $this->url ."/recuperar-clave?token=" . $this->token . "'>Reestablecer Password</a>";
            $contenido .= "<p>Si tu no solicitaste este cambio, puedes ignorar el mensaje</p>";
            $contenido .= '</html>';
            $mail->Body = $contenido;
            $mail->AltBody = 'Esto es texto alternativo sin HTML';
