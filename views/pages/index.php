...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div class="resumen__bloque" <?php aos_animacion(); ?>>
            <p class="resumen__texto resumen__texto--numero"><?php echo $registrados_total; ?></p>
            <p class="resumen__texto"><?php echo ($registrados_total > 1) ? 'Asistentes' : 'Asistente'; ?></p>
        </div>
    </div>
</section>
        ...
        <?php foreach ($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?>   class="speaker">
                <picture>
                    ...
                    <source srcset="<?php echo '/img/speakers/' . $ponente->imagen . '.png'; ?>" type="image/png">
                    <img class="speaker__imagen" loading="lazy" src="<?php echo '/img/speakers/' . $ponente->imagen . '.png'; ?>" width="200" height="300" alt="Imagen ponente">
                </picture>
